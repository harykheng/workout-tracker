          ...
          <Card className="p-5">
            <div className="flex items-center gap-5">
              <ProgressRing value={w.pct} size={128} stroke={11}>
                <span className="text-[30px] font-extrabold leading-none tabular">{w.current}</span>
          ...
          <Card className="p-5">
            <div className="flex items-center gap-5">
              <ProgressRing value={Math.min(100, (streak.current / Math.max(7, streak.best)) * 100)} size={112} stroke={10}>
                <span className="text-[32px] font-extrabold leading-none tabular">{streak.current}</span>
