  ...
  return (
    <div className="anim-screen space-y-5">
      <header className="pt-1">
        <h1 className="text-[26px] font-extrabold leading-tight">Workouts</h1>
                ...
                return (
                  ...
                  >
                    ...
                    <span className="flex-1 min-w-0">
                      ...
                      <span className="block text-[15px] font-bold leading-tight mt-0.5 truncate">{day.title}</span>
              ...
              {SPECIAL_DAYS.map((day) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="flex-1 min-w-0">
                      <span className="block text-[15px] font-bold leading-tight">{day.title}</span>
