      ...
      <Card className="p-5">
        <div className="flex items-center gap-5">
          <ProgressRing value={progress.pct} size={118} stroke={10}>
            <span className="text-[26px] font-extrabold leading-none tabular">{progress.pct}%</span>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[34px] font-extrabold leading-none tabular mt-1">
  ...
  return (
    <header className="flex items-center gap-3 pt-1">
      ...
      <div className="flex-1 min-w-0">
        ...
        <h1 className="text-[21px] font-extrabold leading-tight mt-1 truncate">{day.title}</h1>
      </div>
